...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex xl:hidden flex-col items-center justify-start gap-8 p-2 max-w-7xl mx-auto">
        {/* Background Geometric Shapes */}
        <div
          className="absolute inset-0 opacity-5"
          style={{
        ...
        <div className="relative w-full">
          {/* Profile Image */}
          <div
            className={`relative aspect-square max-w-[80%] min-h-[50vw] mx-auto rounded-full bg-gradient-to-t from-primary-foreground/70 to-transparent overflow-hidden ${
              isLoaded ? "animate-fade-in" : "opacity-0"
            }`}
            style={{ animationDelay: "0.3s" }}
          >
